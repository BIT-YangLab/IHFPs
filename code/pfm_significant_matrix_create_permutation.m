...
for kpk = 1:perm_nc
    disp(['iter: ' num2str(kpk) '/' num2str(perm_nc)]);tic;
...
toc;
save([pred_dst_dir '/permutation_ret/permutation_pfm_homo_seed' num2str(kpk) '.mat'], 'pfm_perm_cell');
toc;
end
