function label_mp = find_local_consistent_region(labels, mesh)
% YLAB_find_local_consistent_region(labels, mesh) to find all consistent region in a brain atlas
% labels is the brain parcellation with each vertice or voxel matching one network
%   mesh is the surface template, like fs_LR_32k, fsaverageX
%
%
%   Examples
